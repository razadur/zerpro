...
<?php if ($this->session->flashdata('flasherror')) { ?>
    ...
    <?php }else{} ?>
                    ...
                    <tr class="gradeA">
                        ...
                        <td><?php echo $get_user->user_email; ?></td>
						<td class="center"><?php echo $get_user->phone_no; ?></td>
                        <td><?php echo $get_user->category; ?></td>
                        
                        <td class="center"><a href="<?php echo base_url(); ?>index.php/admin_panel/user_delete/<?php echo $get_user->user_id; ?>">Delete</a></td>

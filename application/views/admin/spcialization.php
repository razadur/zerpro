                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
												...
												<h3 class="m-t-none m-b">Add New Spcialization</h3>

                                                   

                                                    <form role="form" action="<?php echo base_url();?>admin_panel/save_spcialization" method="POST"  enctype="multipart/form-data">
													<div class="form-group"><label>Category</label> 														<select name="category_name" required class="form-control">
                                                        ...
                                                        <div class="form-group"><label>Spciallization</label> <input type="text" placeholder="Enter Spcialization" class="form-control" name="spcialization"></div>
...
<?php if ($this->session->flashdata('flasherror')) { ?>
    ...
    <?php }else{} ?>
					...
					<?php foreach($get_all_spcializations as $get_all_spcialization){ ?>
					
                    <tr class="gradeA">
                        <td><?php echo $get_all_spcialization->id; ?></td>
                        <td><?php echo $get_all_spcialization->category_name; ?></td>
						<td><?php echo $get_all_spcialization->spcialization; ?></td>
                        
                        <td class="center"><a href="<?php echo base_url(); ?>admin_panel/spcialization_update_form/<?php echo $get_all_spcialization->id; ?>">Update</a> / <a href="<?php echo base_url(); ?>admin_panel/spcialization_delete/<?php echo $get_all_spcialization->id; ?>">Delete</a></td>

    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form role="form" class="form-inline" action="<?php echo base_url();?>admin_panel/spcialization_update" method="POST"  enctype="multipart/form-data">
							<input type="hidden" value="<?php echo $get_spcialization->id; ?>" name="id"/>
                                <div class="form-group">Category Name
                                    <select name="category_name" required class="form-control">
															<option value="<?php echo $get_spcialization->category_name; ?>">"<?php echo $get_spcialization->category_name; ?></option>
														...
														<div class="form-group">Spcialization
                                    					<input type="text" name="spcialization" value="<?php echo $get_spcialization->spcialization; ?>" class="form-control"/>
														</div>

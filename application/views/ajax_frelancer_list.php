<?php foreach($get_freelancers as $get_freelancer){ ?>
    <div class="col-md-4" style="width: 200px; height: 250px;  margin:30px; border: 1px solid #000000; ">
        <div class="col-md-12">
            ...
            <a class="candidate-name" href="<?php echo base_url(); ?>withoutLogin_jobList/frelancer_public_profile/<?php echo $get_freelancer->user_id; ?>" style="font-size: 15px"><?php echo $get_freelancer->name; ?></a><br>
            <?php
